...
public class manageReservationTM {
    ...
    public manageReservationTM() {
    }

    public manageReservationTM(String reservation_id, String customer_id, String equipment_id, String branch_id,
